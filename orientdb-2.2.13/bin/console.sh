...
[ -f "$ORIENTDB_HOME"/lib/orientdb-tools-2.2.13.jar ] || ORIENTDB_HOME=`cd "$PRGDIR/.." ; pwd`
...
exec "$JAVA" -client $JAVA_OPTS $ORIENTDB_SETTINGS $SSL_OPTS \
    -Dfile.encoding=utf-8 -Dorientdb.build.number="2.2.x@r90d7caa1e4af3fad86594e592c64dc1202558ab1; 2016-11-15 12:04:05+0000" \
    -cp "$ORIENTDB_HOME/lib/orientdb-tools-2.2.13.jar:$ORIENTDB_HOME/lib/*:$ORIENTDB_HOME/plugins/*" \
