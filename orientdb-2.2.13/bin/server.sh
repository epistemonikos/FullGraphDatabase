...
exec "$JAVA" $JAVA_OPTS $ORIENTDB_OPTS_MEMORY $JAVA_OPTS_SCRIPT $ORIENTDB_SETTINGS $DEBUG_OPTS \
    ...
    -Dorientdb.build.number="2.2.x@r90d7caa1e4af3fad86594e592c64dc1202558ab1; 2016-11-15 12:04:05+0000" \
    -cp "$ORIENTDB_HOME/lib/orientdb-server-2.2.13.jar:$ORIENTDB_HOME/lib/*:$ORIENTDB_HOME/plugins/*" \
