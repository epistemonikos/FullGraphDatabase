...
while line:
  ...
  # Esta es la unica linea de código que cambia entre create.py y update.py
  # Esto hace que finalmente se re-crea la SR, no se hace update como tal.
  # TODO: hacer update bien
  graph.destroy(sr_node)
